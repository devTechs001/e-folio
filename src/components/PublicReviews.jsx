...
const PublicReviews = ({ limit = 6, showWriteButton = true }) => {
    ...
    return (
        <section className="py-12 sm:py-20 px-4 bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800">
            <div className="max-w-7xl mx-auto">
                ...
                >
                    ...
                    <p className="text-base sm:text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto mb-4 sm:mb-6 px-2">
                    ...
                    {showWriteButton && (
                        <motion.button
                            ...
                            className="w-full sm:w-auto px-6 sm:px-8 py-3 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all flex items-center justify-center gap-2 mx-auto text-sm sm:text-base"
                        >
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
                            {paginatedReviews.map((review, index) => (
                                <motion.div
                                    ...
                                    className="bg-white dark:bg-gray-800 rounded-2xl p-5 sm:p-6 shadow-lg hover:shadow-xl transition-all border border-gray-200 dark:border-gray-700 relative"
                                >
                                    <Quote className="absolute top-4 right-4 text-blue-500 opacity-20 hidden sm:block" size={32} />
                                    ...
                                    <div className="flex items-center gap-3 pt-4 border-t border-gray-200 dark:border-gray-700">
                                        <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-gradient-to-r from-blue-500 to-purple-600 flex items-center justify-center text-white font-semibold text-sm sm:text-base">
                                        ...
                                        <button
                                            ...
                                            className={`flex items-center gap-1.5 px-2.5 sm:px-3 py-1.5 rounded-lg transition-all text-sm ${
                                                likedReviews.has(review._id)
                                                    ? 'bg-blue-500 text-white'
                                                    : 'bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-600'
                                            }`}
                                        >
                                            <ThumbsUp size={14} className={likedReviews.has(review._id) ? 'fill-current' : ''} />
